<div id="block-category">
  ...
  <ul>
    ...
    <li><a id="index1"><img src="/images/mobile-icon.gif" id="mobile-image"/>Мобильные телефоны</a>
    ...
    <li><a id="index2"><img src="/images/book-icon.gif" id="book-image"/>Ноутбуки</a>
      <ul class="category-section">
    ...
    <li><a id="index3"><img src="/images/table-icon.gif" id="table-image"/>Планшеты</a>
      <ul class="category-section">
